...
@catub.cat_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test <media:downloads/thumb_image.jpg> [google]<buttonurl:https://www.google.com> [waruserbot]<buttonurl:https://t.me/waruserbot:same> [support]<buttonurl:https://t.me/catuserbot_support>",
    },
)
async def _(event):
